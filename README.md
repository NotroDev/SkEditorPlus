...
I'm sorry again, but it isn't possible. SkEditor+ runs on .NET 6, which requires a paid [ESU](https://learn.microsoft.com/pl-pl/lifecycle/faq/extended-security-updates). I won't change the version to the older one.
